...
export default defineComponent({
    ...
    setup(props) {
        ...
        const titleRequire = [value=>{
            if(value) return true
            return 'You must enter title'
        }]
        const categoryRequire = [
             (value) => !!value || 'username is required'   
        ]
        const contentsRequire = [
             (value) => !!value || 'username is required'   
        ]
       ...
       onMounted(() => {
        ...
        return {createNote, titleInput, categoryInput, contentsInput, titleRequire, categoryRequire, contentsRequire}
    },
})
</script>
